        ...
        <div class="scroll-reveal scroll-reveal--scale-in bg-white rounded-2xl shadow-sm border border-gray-100 p-8 lg:p-12">
            ...
            <div class="scroll-reveal scroll-reveal--fade-in-up mb-8 text-left">
                <div class="bg-gradient-to-br from-emerald-50 via-white to-amber-50 border-2 border-emerald-100 rounded-2xl p-6 lg:p-8 shadow-sm">
                    ...
                    <div class="bg-emerald-600 rounded-xl p-4 mb-6 text-center">
                        <p class="text-emerald-100 text-sm mb-1">Total yang harus ditransfer</p>
                        <p class="text-2xl font-bold text-white font-['Playfair_Display']">Rp {{ number_format($booking->total_price, 0, ',', '.') }}</p>
                    </div>
                    ...
                    <div class="space-y-4 mb-6">
                        ...
                        <div class="flex gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <a href="https://wa.me/6285136907907?text=Halo%20Embun%20Village%2C%20saya%20telah%20melakukan%20pembayaran%20untuk%20booking%20%23{{ $booking->id }}%20-%20{{ urlencode($booking->room->name) }}%0A%0ANama%3A%20{{ urlencode($booking->guest_name) }}%0ATotal%3A%20Rp{{ number_format($booking->total_price, 0, '', '') }}%0A%0ABerikut%20bukti%20transfernya%3A" target="_blank" class="mt-3 w-full inline-flex items-center justify-center gap-2 px-5 py-3 bg-green-500 hover:bg-green-600 text-white rounded-xl font-semibold text-sm transition-all shadow-md hover:shadow-lg active:scale-[0.98]">
