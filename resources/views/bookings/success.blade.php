                    ...
                    <div class="space-y-4 mb-6">
                        ...
                        <div class="flex gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-gray-500 mt-1">Kirim bukti transfer beserta kode booking <strong>#{{ $booking->id }}</strong> ke <strong>+62 851-3690-7907</strong>.</p>
                                @php
