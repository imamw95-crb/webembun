...
<section class="scroll-reveal scroll-reveal--fade-in-up relative w-full h-[60vh] lg:h-[70vh] overflow-hidden group img-zoom shadow-xl" data-aos="fade-up">
    <img src="<?php echo e(asset('storage/resto/makanan.webp')); ?>" alt="Signature Menu Embun Village" class="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110" loading="lazy">
...
</section><?php /**PATH C:\laragon\www\webembun\resources\views/home/food-banner.blade.php ENDPATH**/ ?>