...
<?php endif; ?>
        ...
        <div class="scroll-reveal scroll-reveal--fade-in-up grid grid-cols-1 lg:grid-cols-5 gap-4 lg:gap-6 mb-12 lg:mb-16" data-aos="fade-up">
            <div class="lg:col-span-3 relative group rounded-2xl overflow-hidden h-72 lg:h-[28rem] img-zoom shadow-lg shadow-amber-900/10">
                <img src="<?php echo e(asset('storage/resto/outdor.webp')); ?>" alt="Outdoor Dining Embun Village" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" loading="lazy">
...
<?php endif; ?>
            ...
            <div class="lg:col-span-2 grid grid-cols-2 lg:grid-cols-1 gap-4 lg:gap-6">
                <div class="relative group rounded-2xl overflow-hidden h-48 lg:h-[13.5rem] img-zoom shadow-lg shadow-amber-900/10">
                    <img src="<?php echo e(asset('storage/resto/dalam%20resto.webp')); ?>" alt="Restaurant Interior" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" loading="lazy">
                ...
                <div class="relative group rounded-2xl overflow-hidden h-48 lg:h-[13.5rem] img-zoom shadow-lg shadow-amber-900/10">
                    <img src="<?php echo e(asset('storage/resto/dalam%20resto%202.webp')); ?>" alt="Restaurant Interior" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" loading="lazy">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent"></div>
                    <div class="absolute bottom-4 left-4">
...
</section><?php /**PATH C:\laragon\www\webembun\resources\views\home\restaurant.blade.php ENDPATH**/ ?>