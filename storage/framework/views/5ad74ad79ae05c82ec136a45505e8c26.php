...
<section class="hero-slideshow relative min-h-[100dvh] flex items-center overflow-hidden bg-gray-900" id="hero">
    ...
    <div class="hero-slides-container absolute inset-0">
        <div class="hero-slide active" data-slide="0" style="background-image: url('<?php echo e(asset('storage/baner/dome%20luar.webp')); ?>');"></div>
...
</section><?php /**PATH C:\laragon\www\webembun\resources\views\home\hero.blade.php ENDPATH**/ ?>