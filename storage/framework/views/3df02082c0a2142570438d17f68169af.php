...
<section class="relative py-20 lg:py-28 bg-gray-900 overflow-hidden">
    ...
    <div class="absolute inset-0 bg-cover bg-center opacity-25" style="background-image: url('<?php echo e(asset('images/EMBUN/dalam%20resto.webp')); ?>')"></div>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-8 h-8 text-emerald-600']); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\webembun\resources\views\about.blade.php ENDPATH**/ ?>